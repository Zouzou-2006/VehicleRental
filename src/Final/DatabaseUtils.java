...
public class DatabaseUtils
{
		...
		public static boolean OpenDatabaseConnectionSQLServer( )
		{
			...
			try
			{
				...
				//sdsTeamsAndPlayers.setServerName( "COMPUTERNIZAR\\MSSQLSERVER01" ); // SQL Express version
				sdsTeamsAndPlayers.setPortNumber( 1433 );
				sdsTeamsAndPlayers.setDatabaseName( "dbHCM" );
				sdsTeamsAndPlayers.setTrustServerCertificate(true);
				...
				// Login Type:
					...
					// SQL Server
				     sdsTeamsAndPlayers.setUser( "dbuser" );
					 sdsTeamsAndPlayers.setPassword( "Password123!" );	// Empty string "" for blank password
